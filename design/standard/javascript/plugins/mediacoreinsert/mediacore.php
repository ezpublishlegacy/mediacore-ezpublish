...
<head>
	...
	<script type="text/javascript" src="/extension/ezoe/design/standard/javascript/tiny_mce_popup.js"></script>
	<script type="text/javascript" src="/extension/mediacoreinsert/design/standard/javascript/plugins/mediacoreinsert/js/mediacore.js"></script>
	<link rel="stylesheet" type="text/css" href="/extension/mediacoreinsert/design/standard/javascript/plugins/mediacoreinsert/css/mediacore.css"/>
...
<div id="mcore-embed">
	...
	// s = 128x72
	// xs = 64x36
	// Change the 'l' in $video->thumbs->l->x & y to 'ml' if you want the 
	// embed to be 304x171
...
<a href="javascript:MediaCoreDialog.insert('<?php echo embeddable($video->url); ?>', '<?php echo $video->title; ?>','<?php echo $embedwidth ?>','<?php echo $embedheight ?>');">
